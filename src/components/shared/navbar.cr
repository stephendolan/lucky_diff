class Shared::Navbar < BaseComponent
  ...
  private def github_logo
    tag "svg", aria_hidden: "true", class: "svg-inline--fa fa-github fa-w-16", data_icon: "github", data_prefix: "fab", focusable: "false", role: "img", viewBox: "0 0 496 512", xmlns: "http://www.w3.org/2000/svg" do
