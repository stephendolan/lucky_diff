...
FROM crystallang/crystal:1.2.2-alpine as crystal_dependencies
...
FROM crystallang/crystal:1.2.2-alpine as lucky_tasks_build
ENV LUCKY_ENV=production
...
FROM crystallang/crystal:1.2.2-alpine as lucky_webserver_build
