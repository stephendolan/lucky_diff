...
FROM crystallang/crystal:1.5.0-alpine as crystal_dependencies
...
FROM crystallang/crystal:1.5.0-alpine as lucky_tasks_build
ENV LUCKY_ENV=production
...
FROM crystallang/crystal:1.5.0-alpine as lucky_webserver_build
